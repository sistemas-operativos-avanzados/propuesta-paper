...
%It is argued that the energy efficiency of InterDVS algorithms depends significantly of slack estimation and the appropriateness of slack distribution. The following highlights the results obtained when evaluating InterDVS algorithms.
...
%Since in these systems resource demands differs from the ones presented in hard real-time systems, performance improvements are approached depending of the application quality of service (QoS) that is being intended to be improved, for instance disks access, multimedia or network utilization. 
%
%\begin{itemize}
